...
My name is Jeff, and I'm a fourth-year undergraduate at the University of Southern California majoring in Neuroscience. I'm also a licensed dialysis technician at Laurel Canyon Dialysis Center, where my work with patients has shaped my goal of becoming a transplant physician to restore quality of life for people living with kidney failure. My research in Dr. Nelson's lab focuses on single-cell and spatial kidney datasets. In my free time, I love to hike and play nostalgic games like Roblox and Wizard101.
...
<img src="`r here::here('images', "lab_members", 'paul.jpg')`" 
    width="300px"
    height="300px"
    style="object-fit: cover; object-position: middle;">

Hello! My name is Paul Cho, a third-year undergraduate student at the University of Southern California majoring in Human Biology and minoring in Cinematic Arts! I have been a part of Dr. Nelson's Lab since August 2025. My research focuses on using spatial transcriptomics to explore how Alport syndrome affects tertiary lymphoid structures in the kidney as well as using single-cell RNA sequencing to study how Angiotensin II affects the transcriptional pattern of kidney cells.
...
Sam de Leve is a science communicator and a postbaccalaureate trainee. Prior to joining the Nelson Lab, they studied liver sinusoidal endothelial cell biology with the DeLeve lab in the GI/Liver Division at USC Keck School of Medicine.
