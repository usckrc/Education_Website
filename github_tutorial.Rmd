...
![](`r here::here("images", "github_tutorial", "Github_Login.png")`)
...
![](`r here::here("images", "github_tutorial", "Github_Clone.png")`)

## Step 2

Select the repository you want to clone and the destination to clone into. 

![](`r here::here("images", "github_tutorial", "Github_Clone2.png")`)

## Step 3

Check the folders where the repository has been cloned.

![](`r here::here("images", "github_tutorial", "Github_Clone_Folders.png")`)

## Step 4

Verify that the repository has been cloned in Github Desktop.

![](`r here::here("images", "github_tutorial", "Github_Clone_Menu.png")`)
