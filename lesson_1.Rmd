...
You can download this file from the [GEO entry](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE111107) or download it from [Google Drive](https://drive.google.com/file/d/16JzkZN2qmUzK8bg1_D2x3vRstWrqvHUE/view?usp=sharing). To follow along with this tutorial you can download the [R Script](https://drive.google.com/file/d/1RODN4wE31qgnaK6_WjnC1BihtVgX7fMu/view?usp=sharing) and run it or create your own and copy the code from the tutorial into the script.

To be able to follow along with this tutorial you should have R and RStudio downloaded. If you need help doing this a tutorial can be found [here](file:///Users/sblanche/Desktop/GitHub/Education_Website/docs/downloading_R.html)
...
## Setting up a "Working Directory" and uploading the scRNAseq file to R studio
