...
![](`r here::here("images", "recreating_figures", "Replica.png")`)

## Venn Diagrams

![](`r here::here("images", "recreating_figures", "Potter.png")`)
...
![](`r here::here("images", "recreating_figures", "DEGlists.png")`)
...
![](`r here::here("images", "recreating_figures", "Venn1.png")`)
...
![](`r here::here("images", "recreating_figures", "Venn2.png")`)
...
![](`r here::here("images", "recreating_figures", "Upset_Example.png")`)
...
![](`r here::here("images", "recreating_figures", "gantt_chart.png")`)

## History

![](`r here::here("images", "recreating_figures", "gantt.png")`)

![](`r here::here("images", "recreating_figures", "gantt_history.png")`)

https://en.wikipedia.org/wiki/Gantt_chart

## Great for Project Management

![](`r here::here("images", "recreating_figures", "GanttChartAnatomy.svg.png")`)
...
![](`r here::here("images", "recreating_figures", "mentor_csv.png")`)

## Load Data, Define Institutes vs. Individuals, and Pivot Longer

![](`r here::here("images", "recreating_figures", "gantt_code1.png")`)

![](`r here::here("images", "recreating_figures", "pivot.png")`)
...
![](`r here::here("images", "recreating_figures", "gantt_code2.png")`)
...
![](`r here::here("images", "recreating_figures", "gantt_code3.png")`)
...
![](`r here::here("images", "recreating_figures", "sankey_final.png")`)

## Inspiration

![](`r here::here("images", "recreating_figures", "airplane_sankey.jpg")`)
...
![](`r here::here("images", "recreating_figures", "professor_sankey.jpg")`)
...
![](`r here::here("images", "recreating_figures", "job_sankey.webp")`)

[**Source**](https://www.reddit.com/r/math/comments/ccd9sl/my_job_hunt_as_a_new_phd/)

![](`r here::here("images", "recreating_figures", "job_sankey2.png")`)

[**Source**](https://www.reddit.com/r/academia/comments/16lyfx3/3_year_faculty_application_journey_in_sankey/)

## History

![](`r here::here("images", "recreating_figures", "sankey_wiki.png")`)

![](`r here::here("images", "recreating_figures", "sankey_wiki2.png")`)
...
![](`r here::here("images", "recreating_figures", "sankey_xlsx1.png")`)

### Research Output

![](`r here::here("images", "recreating_figures", "sankey_xlsx2.png")`)
...
![](`r here::here("images", "recreating_figures", "sankey1.png")`)
...
![](`r here::here("images", "recreating_figures", "sankey2.png")`)
...
p_plotly <- plotly::ggplotly(p1, tooltip = "text")
...
![](`r here::here("images", "recreating_figures", "stacked.png")`)
...
![](`r here::here("images", "recreating_figures", "park.png")`)

### Figure 1 from Karaiskos et al. JASN 2018

https://pubmed.ncbi.nlm.nih.gov/29794128/

![](`r here::here("images", "recreating_figures", "karaiskos.png")`)
...
![](`r here::here("images", "recreating_figures", "burfiend.png")`)
...
![](`r here::here("images", "recreating_figures", "dimplot.png")`)
...
![](`r here::here("images", "recreating_figures", "vlnplots.png")`)
...
![](`r here::here("images", "recreating_figures", "vlnplot.png")`)
